...
/* add the initial starter track to the map*/
allTracks.push(starterTrack);
addStar(starterTrack);
...
function markCurrentTrackAsPlayed() {
  ...
  scene.children.forEach((object) => {
    ...
    if (object.star && currentTrack.data && object.data.id == currentTrack.data.id) {
